class LocalisationInstruction {
  ...
  String getInstruction(int direction, String name) {
    String instruction = languageCodeDirection[languageCode][direction];
    switch (name.isEmpty) {
      case true:
  ...
  static final Map<int, String> _defaultDirectionEn = {
    ...
    24: "ou have reached a waypoint of your trip",
    2: "[Go on %s]",
    ...
    17: "Take the ramp [on %s]the left [on %s]",
    18: "Take the ramp [on %s]the right [on %s]",
    19: "Take the ramp [on %s]the ahead [on %s]",
  };
}
